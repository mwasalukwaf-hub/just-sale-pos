    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto text-uppercase small">
                ...
                <li class="nav-item"><a class="nav-link btn btn-outline-primary rounded-pill px-4 ms-lg-3" href="login.php">Login</a></li>
            </ul>
        </div>
    </div>
</nav>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-4">
                <div class="pricing-card">
                    ...
                    <a href="register.php?plan=starter" class="btn btn-outline-primary w-100 py-3 rounded-pill fw-bold">Sign Up</a>
                </div>
            </div>
            <!-- Professional Plan -->
            <div class="col-md-4">
                <div class="pricing-card featured">
                    ...
                    <a href="register.php?plan=pro" class="btn btn-primary w-100 py-3 rounded-pill fw-bold shadow">Activate Now</a>
                </div>
            </div>
        </div>
    </div>

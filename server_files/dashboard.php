    ...
    <div class="row">
        ...
        <div class="col-md-2 d-none d-md-block sidebar shadow">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link" href="buy.php"><i class="fa-solid fa-cart-shopping me-3"></i> Buy Key</a>
                <a class="nav-link" href="settings.php"><i class="fa-solid fa-user me-3"></i> Profile</a>
                <hr class="opacity-20">
                <a class="nav-link text-danger" href="logout.php"><i class="fa-solid fa-sign-out-alt me-3"></i> Logout</a>
            </nav>
        </div>
        ...
        <div class="col-md-10 py-5 px-md-5">
            <div class="d-flex justify-content-between align-items-center mb-5">
                ...
                <a href="buy.php" class="btn btn-primary px-4 py-2 rounded-pill fw-bold"><i class="fa-solid fa-plus me-2"></i> New License</a>
            </div>
